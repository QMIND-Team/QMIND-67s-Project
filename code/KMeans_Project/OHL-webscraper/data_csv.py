...
def get_range(leagues=['OHL'], start_season='2017-18', end_season='2018-19', players='skaters', strength=[' '],
            ...
            for season in seasons:
                for play in players:
                    for play_type in strength:
                        csvs.append(league + '_' + season + '_' + play + '_' + play_type + '.csv')
...
def get_all_combos(leagues=['OHL'], start_season='2017-18', end_season='2018-19', players=['skaters'],
...
def merge(csvs, filename,  max_appearances, all_strings=False, min_years=1, sort='P'):
