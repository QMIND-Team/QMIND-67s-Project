...
"""
    These functions are used to scrape multiple stats from prospect-stats.com and 
    merge the stats into one data frame.  Run the function get_stats_scrape().
"""

def get_stats_scrape(leagues=['OHL'], start_season='2018-19', end_season='2018-19', players='skaters', strength=[' '],
                      top_ten=False, played_all_years=False, sort='P', ascending=False):
    """Function to scrape prospect stats website for individual players stats.
        ...
        Args:
            ...
            played_all_years (boolean): True if only want players that played every year and league.
...
#get_stats_scrape(leagues=['OHL', 'QMJHL'], start_season='2017-18', end_season='2018-19', players='forwards', strength=['5v5', '4v4'], top_ten=True)
